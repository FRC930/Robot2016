 ...
 *
 */
public class AutoCheval2TurnDrive extends Command {
    ...
    public AutoCheval2TurnDrive(double driveTime1, double lowerDriveTime, double raiseTime, double turnAngle1, double turnTime1, double driveTime2, double turnTime2, double driveTime3, double driveSpeed) {
