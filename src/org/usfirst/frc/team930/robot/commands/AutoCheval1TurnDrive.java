 ...
 *
 */
public class AutoCheval1TurnDrive extends Command {
    ...
    public AutoCheval1TurnDrive(double driveTime1, double lowerDriveTime, double raiseTime, double turnAngle, double turnTime, double driveTime2, double driveSpeed) {
