 ...
 *
 */
public class Auto2TurnDrive extends Command {
	...
	public static final double TURN_2_TIME = 1;
	public static final double DRIVE_3_TIME = 3;
    ...
    public Auto2TurnDrive(double driveTime1, double turnAngle1, double turnTime1, double driveTime2, double turnTime2, double driveTime3, double driveSpeed) {
    	...
    	thisTurnAngle1 = turnAngle1;
    	thisTurnTime1 = turnTime1;
    	thisDriveTime2 = driveTime2;
    	thisTurnTime2 = turnTime2;
    	thisDriveTime3 = driveTime3;
