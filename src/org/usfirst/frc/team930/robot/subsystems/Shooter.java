...
public class Shooter extends Subsystem {
	...
	public Shooter() {
		 ...
		 * 
		 * shooter1.enableBrakeMode(false); shooter2.enableBrakeMode(false);
		 * 
	...
	public void setShooter(double rpm) {
		...
		//
		// tempSpeed = ((rpm - 30.0/rpmSource.getPeriod()) *
		// RobotConstants.shooterP) / RobotConstants.shooterMaxSpeed;
		// if(tempSpeed <0){
		// shooter1.set(0);
		// shooter2.set(0);
		// }
	...
	/*
	 * public double encoderPulses() { //return shooter1.getEncPosition();
	 * 
	 * }
	 */
	...
	public void print() {
		...
		// SmartDashboard.putNumber("Shooter1Speed",
		// 30.0/rpmSource.getPeriod());
